 ...
 *  - applied PR https://github.com/kayahr/console-shim/pull/8 to remove possible memory leak
 *  - removed "log4javascript" check
...
if (global["__consoleShimTest__"] != null || document.documentMode <= 9)
// originaly was (not work in IE emulation): eval("/*@cc_on @_jscript_version <= 9@*/"))
{
    ...
    if (global.console["time"]) {
        global.console.time = bind(wrap, global, global.console.time);
        global.console.timeEnd = bind(wrap, global, global.console.timeEnd);
    }
}
