...
interface JQuery {
	...
	notify(method: string, template: number, params?: any, opts?: JQueryNotifyOptions): JQueryNotifyInstance;
	notify(method: string, params?: any, opts?: JQueryNotifyOptions): JQueryNotifyInstance;
}
